...
'-------------------------------------------------------------------------------
Sub UI_Node_PlaceBottomLeft(node as Object, toNode as Object, options=invalid as Object)
...
'-------------------------------------------------------------------------------
Sub UI_Node_PlaceInsideBottomRight(node as Object, toNode as Object)

	boundaryToNode = toNode.BoundingRect()
	boundaryNode = node.BoundingRect()
	node.translation = [(boundaryToNode.width - boundaryNode.width), (boundaryToNode.height - boundaryNode.height)]
End Sub
